<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"D:\Apache24\htdocs\GitHub\cccop1.0\public/../application/index\view\announce\ann_add.html";i:1520646832;s:86:"D:\Apache24\htdocs\GitHub\cccop1.0\public/../application/index\view\public\header.html";i:1508149305;}*/ ?>
<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="page-container">
    <form class="form form-horizontal" action="<?php echo url('announce/add'); ?>" method="post">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text"  placeholder="管理员" id="author" name="author">
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <script id="editor" type="text/plain" style="width:100%;height:400px;" name="content" ></script></div>
                </div>
                <div class="row cl">
