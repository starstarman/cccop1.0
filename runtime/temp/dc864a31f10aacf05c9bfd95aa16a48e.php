<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"F:\Apache24\htdocs\cccop1.0\public/../application/index\view\form\createform.html";i:1520328093;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
    ...
    <script type="text/javascript" src="__STATIC__/data_jquery/js/jquery-1.11.0.min.js"></script>
    <!--<link type="text/css" rel="stylesheet" href="__STATIC__/data_jquery/css/admin.css" />-->
        <link rel="stylesheet" type="text/css" href="__STATIC__/data_jquery/css/jquery-ui.css" />
        <script type="text/javascript" src="__STATIC__/data_jquery/js/jquery-ui-1.10.4.custom.min.js"></script>
    <script type="text/javascript" src="__STATIC__/data_jquery/js/jquery.ui.datepicker-zh-CN.js"></script>
    <script type="text/javascript" src="__STATIC__/data_jquery/js/jquery-ui-timepicker-addon.js"></script>
    <script type="text/javascript" src="__STATIC__/data_jquery/js/jquery-ui-timepicker-zh-CN.js"></script>
    <style>
...
<div class="container"style="margin-left: 20px; margin-right: 20px">
    <div class="row clearfix" style="width: 1400px">
        <div style="width: auto; position:absolute;float: left;margin-left: 35px">
            <div class="clearfix">
                <h3>设计表单<?php echo $data; ?>
                    <div style="float: right">

                    <span class="dropDown"> <a class="dropDown_A btn btn-default" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">设置审批流程</a>
	                    <ul class="dropDown-menu menu radius box-shadow">
		                    <li style="font-size: 18px"><a href="#" id="set" style="color: #827d7d">单流程</a></li>
		                    <li style="font-size: 18px"><a href="#" id="set1"  style="color: #827d7d">双流程</a></li>
	                    </ul>
                    </span>
                        <button class='btn btn-default' style="font-weight: bold" id="preview" type='submit'>设置表单样式</button>
                        <button class='btn btn-default' style="font-weight: bold" id="tijiao" type='submit'>发布</button>
                            <input name="start_time"  type="text" class="text-box" value="" placeholder="开始时间" readonly="readonly" style="cursor:pointer; width:150px"/>
                            <input name="end_time" type="text" class="text-box" value="" placeholder="结束时间" readonly="readonly" style="cursor:pointer;width:150px"/>
                    </div>
                </h3>
                <hr>
                <div id="build">
                    <form id="target" class="form-horizontal">
                        <fieldset class="parent" style="width: 1029px">
                  ...
                  <div class='controls'>
                    ...
                    <button class='btn btn-info' type='button'>确定</button><button class='btn btn-danger' type='button'>取消</button>
                            ...
                            >
                                ...
                                <legend class="title1 leipiplugins-orgvalue" style="text-align: center;font-size: 32px;         line-height: 51px;">点击填写表单名</legend>
                            </div>
                        </fieldset>
                    </form>
                </div>
        ...
        <div style="width: 236px; float:right">
            <h3 style="margin-left: 20px">常用组件</h3>
  ...
  <form class='form'>
    <div class='controls'>
      ...
      <button class='btn btn-info' type='button'>确定</button><button class='btn btn-danger' type='button'>取消</button>
                                ...
                                <!-- Textarea start -->
                                <div class="control-group component span1-4" rel="popover" title="多行文本控件" trigger="manual"
                                     data-content="
    <form class='form'>
    <div class='controls'>
      <label class='control-label'>控件名称</label> <input type='text' id='orgname' placeholder='必填项'>
      ...
      <button class='btn btn-info' type='button'>确定</button><button class='btn btn-danger' type='button'>取消</button>
                                ...
                                >
                                    <!-- Textarea -->
                                    <label class="control-label leipiplugins-orgname" style="text-align: left;float: none" >多行文本</label>
                                    <div class="controls"  style="margin-left: 1px; margin-right: 1px;float: left;width: auto">

                                        <div class="textarea">
                                            <textarea title="多行文本"  id="abcd"  name="leipiNewField" class="leipiplugins"
                                                      leipiplugins="textarea"/> </textarea>
                                        </div>
                                    </div>
                                </div>

                                <div class="control-group component span1-4" rel="popover" title="签字控件" trigger="manual"
                                     data-content="
    <form class='form'>
    <div class='controls'>
      <label class='control-label'>控件名称</label> <input type='text' id='orgname' placeholder='必填项'>
...
//              }
    ...
    $('#preview').click(function () {
        $("textarea").css("resize","both");//将多行文本设置为可抻拉 resize:both

        //获取数据
        var str= $('fieldset').html();
        var data_post={
            'data_po':str,
        };
        //抛送逻辑
        var url ="<?php echo url('form/preview'); ?>";
        $.post(url,data_post,function (data) {
            attrbut(data);
        },"json");
        //弹窗
