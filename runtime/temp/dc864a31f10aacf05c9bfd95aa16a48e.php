                ...
                <h3>设计表单<?php echo $data; ?>
                    ...
                    <span class="dropDown"> <a class="dropDown_A btn btn-default" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">设置审批流程</a>
                        ...
                        <button class='btn btn-default' style="font-weight: bold" id="tijiao" type='submit'>发布</button>
                            <input name="start_time"  type="text" class="text-box" value="" placeholder="开始时间" readonly="readonly" style="cursor:pointer; width:150px;margin-bottom:-1px"/>
                            <input name="end_time" type="text" class="text-box" value="" placeholder="结束时间" readonly="readonly" style="cursor:pointer;width:150px;margin-bottom:-1px"/>
                    </div>
                </h3>
                <hr>
                <div id="build">
